...
yo push (commit everything and push to branch) (will fail with message on develop)
yo commit (commit everything with an empty message, push to remote) (will fail with message on develop)
